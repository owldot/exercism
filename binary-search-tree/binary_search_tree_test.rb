...
class BstTest < Minitest::Test
  ...
  def test_smallest
    ...
    four.insert 7
    four.insert 5
    assert_equal 1, four.find_smallest.data
  end
  ...
  def test_to_a
    ...
    four.insert 7
    four.insert 5
    assert_equal [1, 2, 3, 4, 5, 6, 7], four.to_a
  end
  ...
  def test_search
    ...
    four.insert 7
    four.insert 5
    assert four.search(5)
    refute four.search(3)
  end
  ...
  def test_levels
    ...
    assert_equal [[1, 3, 5, 7], [2, 6], [4]], root.levels
